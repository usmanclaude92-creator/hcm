    ...
    () => [
      {
        ...
        items: [
          ...
          },
          {
            ...
            icon: UserPlus,
            targetView: 'employees',
            targetParams: { openAddModal: true },
            badge: 'Form',
            kind: 'form',
            keywords: ['add employee', 'hire', 'onboard', 'new worker', 'civil id', 'visa'],
          },
          {
            id: 'employee-ledger',
          ...
          },
          {
            ...
            badge: 'Shifts',
            keywords: ['deployment', 'site', 'assignments', 'allocation', 'roster'],
          },
          {
            id: 'attendance',
          ...
          },
          {
            ...
            icon: CalendarPlus,
            targetView: 'leave',
            targetParams: { initialOpenModal: true },
            badge: 'Form',
            kind: 'form',
            keywords: ['apply leave', 'request leave', 'vacation form'],
          },
          {
            id: 'compliance',
      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            icon: Building,
            targetView: 'master-data',
            targetParams: { tab: 'companies' },
            badge: 'Legal/CR',
            kind: 'master',
            keywords: ['company', 'legal entity', 'cr number', 'tax id', 'oman llc'],
          },
          {
            ...
            icon: Network,
            targetView: 'master-data',
            targetParams: { tab: 'departments' },
            kind: 'master',
            keywords: ['departments', 'divisions', 'units', 'org'],
          },
          {
            ...
            icon: Briefcase,
            targetView: 'master-data',
            targetParams: { tab: 'designations' },
            kind: 'master',
            keywords: ['designations', 'job titles', 'roles', 'positions'],
          },
          {
            id: 'master-trade',
            label: 'Trade & Skill Master',
            icon: Wrench,
            targetView: 'master-data',
            targetParams: { tab: 'trades' },
            kind: 'master',
            keywords: ['trades', 'skills', 'crafts', 'civil', 'electrical', 'carpenter'],
          },
          {
            id: 'projects',
            ...
            badge: 'Directory',
            kind: 'master',
            keywords: ['projects', 'sites', 'contracts', 'cost centers'],
          },
          {
            id: 'project-add-form',
            ...
            icon: FolderPlus,
            targetView: 'projects',
            targetParams: { initialOpenAddModal: true },
            badge: 'Form',
            kind: 'form',
            keywords: ['new project', 'add project', 'create site', 'project form'],
          },
          {
            id: 'master-geofence',
            label: 'Project Geofence Locations',
            icon: MapPin,
            targetView: 'master-data',
            targetParams: { tab: 'locations' },
            badge: 'GPS Gate',
            kind: 'master',
            keywords: ['geofence', 'gps', 'gates', 'radius', 'coordinates', 'latitude', 'longitude'],
          },
          {
      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            targetView: 'loans',
            targetParams: { initialOpenNewLoan: true },
            badge: 'Form',
            kind: 'form',
            keywords: ['apply loan', 'sanction loan', 'new advance', 'loan form'],
          },
          {
            id: 'gratuity',

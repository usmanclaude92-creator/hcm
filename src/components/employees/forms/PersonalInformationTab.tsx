...
export const PersonalInformationTab: React.FC<PersonalInformationTabProps> = ({
  ...
  return (
    <div className="space-y-6">
      {identityError && (
        <div className="p-3 bg-rose-50 dark:bg-rose-900/30 border border-rose-200 dark:border-rose-800/60 text-rose-800 dark:text-rose-300 rounded-xl text-xs flex items-center justify-between animate-fadeIn">
      ...
      <div className="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-700 p-5 shadow-xs">
        <div className="flex items-center justify-between border-b border-slate-100 dark:border-slate-800 pb-3 mb-4">
          ...
          <div className="flex items-center gap-2">
            ...
            {employee ? (
              <span className="text-xs bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-300 px-2.5 py-1 rounded-full font-semibold">
                ID: <strong className="font-mono text-blue-600 dark:text-blue-400">{employee.employeeId}</strong>
              </span>
            ) : (
              <span className="text-xs bg-blue-50 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 px-2.5 py-1 rounded-full font-semibold flex items-center gap-1">
          ...
          <div className="flex flex-col sm:flex-row items-center sm:items-start gap-4">
            ...
            <div className="flex flex-col items-center sm:items-start shrink-0">
              ...
              <div
                ...
                className={`relative group w-28 h-28 sm:w-32 sm:h-32 rounded-2xl overflow-hidden border-2 transition-all flex items-center justify-center cursor-pointer select-none shadow-2xs ${
                  isDraggingPhoto
                    ? 'border-blue-500 bg-blue-50 dark:bg-blue-900/30 ring-4 ring-blue-100 scale-102'
                    : currentPhoto
                    ? 'border-slate-200 dark:border-slate-700 bg-slate-100 dark:bg-slate-800 hover:border-blue-400'
                    : 'border-dashed border-slate-300 dark:border-slate-600 hover:border-blue-500 bg-white dark:bg-slate-900 hover:bg-blue-50/40'
                }`}
              ...
              >
                {currentPhoto ? (
                  ...
                  <div className="flex flex-col items-center justify-center p-2 text-center">
                    <div className="w-10 h-10 rounded-full bg-blue-50 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 flex items-center justify-center mb-1 group-hover:scale-110 transition-transform">
                    ...
                    <span className="text-[9px] text-slate-400 dark:text-slate-500">Click / Drop</span>
                  </div>
                )}
                ...
                {currentPhoto && (
                  <div className="absolute bottom-1.5 right-1.5 bg-white/95 p-1 rounded-full shadow-xs border border-slate-200 dark:border-slate-700 text-slate-600 dark:text-slate-400 group-hover:opacity-0 transition-opacity pointer-events-none">
                    <Camera size={11} />
                  </div>
                )}
              </div>
            ...
            <div className="flex-1 text-center sm:text-left space-y-2">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
                <div>
                  <h4 className="text-xs font-bold text-slate-800 dark:text-slate-200 flex items-center justify-center sm:justify-start gap-1.5">
                    <Camera size={14} className="text-blue-600 dark:text-blue-400" />
                    <span>Employee Photo (Headshot)</span>
                    {currentPhoto ? (
                      <span className="text-[10px] bg-emerald-100 dark:bg-emerald-900/40 text-emerald-800 dark:text-emerald-300 font-semibold px-2 py-0.5 rounded-full flex items-center gap-1">
                        <CheckCircle2 size={10} /> Photo Attached
                      </span>
                    ) : (
                      <span className="text-[10px] bg-blue-50 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 font-semibold px-2 py-0.5 rounded-full">
                        Recommended
                      </span>
                    )}
                  </h4>
                    ...
                    {currentPhoto && (
                      <>
                        <button
                          ...
                          className="text-xs font-semibold px-2.5 py-1.5 bg-white dark:bg-slate-900 hover:bg-slate-100 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-300 border border-slate-200 dark:border-slate-700 rounded-lg transition-colors flex items-center gap-1 shadow-2xs cursor-pointer"
                          title="Adjust zoom and frame center"
                        >
                          <Crop size={12} className="text-blue-600 dark:text-blue-400" />
                        ...
                        >
                          <Maximize2 size={12} className="text-slate-500 dark:text-slate-400" />
                        ...
                        <button
                          ...
                          className="text-xs font-semibold px-2.5 py-1.5 bg-rose-50 dark:bg-rose-900/30 hover:bg-rose-100 dark:hover:bg-rose-900/50 text-rose-700 dark:text-rose-300 border border-rose-200 dark:border-rose-800/60 rounded-lg transition-colors flex items-center gap-1 shadow-2xs cursor-pointer"
                          title="Remove photo"
                        >
                          <Trash2 size={12} />
                          <span>Remove</span>
              ...
              {/* Photo Error Banner */}
              {photoError && (
                <div className="p-2 bg-rose-50 dark:bg-rose-900/30 border border-rose-200 dark:border-rose-800/60 rounded-lg text-rose-700 dark:text-rose-300 text-[11px] font-medium flex items-center gap-1.5">
              ...
              {/* Specs description */}
              <div className="flex flex-wrap items-center justify-center sm:justify-start gap-2 pt-0.5 text-[10px] text-slate-500 dark:text-slate-400">
                <span className="flex items-center gap-1">
                  <CheckCircle2 size={10} className="text-emerald-600 dark:text-emerald-400" /> JPG, PNG, WEBP
                </span>
                <span>•</span>
                <span>Max 12MB</span>
                <span>•</span>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <>
              <div>
                <label className="block text-xs font-semibold text-slate-700 dark:text-slate-300 mb-1 flex items-center justify-between">
                  ...
                  <span className="text-[10px] text-blue-600 dark:text-blue-400 font-mono font-medium">EMP ID</span>
                </label>
                <input
                  type="text"
                  required
                  ...
                  className="w-full px-3 py-2 border border-slate-200 dark:border-slate-700 rounded-lg text-xs uppercase font-mono font-bold focus:ring-2 focus:ring-blue-500 bg-white dark:bg-slate-900"
                />
              </div>
              ...
              <div className="sm:col-span-2">
                ...
                <input
                  ...
                  className="w-full px-3 py-2 border border-slate-200 dark:border-slate-700 rounded-lg text-xs font-medium focus:ring-2 focus:ring-blue-500 bg-white dark:bg-slate-900"
                />
              </div>
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-3 py-2 text-xs border border-slate-200 dark:border-slate-700 rounded-lg focus:ring-2 focus:ring-blue-500 bg-white dark:bg-slate-900 placeholder:text-slate-400"
            />
          </div>
          ...
          <div>
            <div className="flex items-center justify-between mb-1">
              ...
              {age !== null && (
                <span className="text-[11px] font-semibold text-blue-700 dark:text-blue-300 bg-blue-50 dark:bg-blue-900/30 px-2 py-0.2 rounded-md">
                  {age} yrs old
                </span>
              )}
            </div>
          ...
          <div>
            ...
            <select
              ...
              className="w-full px-3 py-2 text-xs border border-slate-200 dark:border-slate-700 rounded-lg focus:ring-2 focus:ring-blue-500 bg-white dark:bg-slate-900 font-mono"
            >
            ...
            <span
              className={`inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full text-[11px] font-semibold border ${
                hasCivilIdFile
                  ...
                  : 'bg-amber-50 dark:bg-amber-900/30 text-amber-700 dark:text-amber-300 border-amber-200 dark:border-amber-800/60'
              }`}
            >
              <CreditCard size={12} />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
              ...
              <div className="flex items-center justify-between mb-2">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-[10px] text-slate-500 dark:text-slate-400">Royal Oman Police (ROP)</p>
                  </div>
                </div>
                {hasCivilIdFile && (
                  <span className="inline-flex items-center gap-0.5 text-[10px] font-semibold text-emerald-600 dark:text-emerald-400 bg-emerald-50 dark:bg-emerald-900/30 border border-emerald-200 dark:border-emerald-800/60 px-1.5 py-0.5 rounded-md">
              ...
              <div className="grid grid-cols-2 gap-2 mb-3">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-2.5 py-1.5 text-xs font-mono font-bold border border-slate-200 dark:border-slate-700 rounded-lg bg-white dark:bg-slate-900 focus:ring-2 focus:ring-blue-500"
                  />
                </div>
                <div>
                  <label className="text-[10px] font-semibold text-slate-600 dark:text-slate-400 block mb-0.5">
                  ...
                  <input
                    ...
                    className="w-full px-2.5 py-1.5 text-xs border border-slate-200 dark:border-slate-700 rounded-lg bg-white dark:bg-slate-900 focus:ring-2 focus:ring-blue-500"
                  />
                </div>
              </div>
          ...
          <div className="rounded-xl border border-slate-200/90 bg-slate-50/50 p-4 flex flex-col justify-between space-y-3">
            <div>
              <div className="flex items-center justify-between mb-2">
                <div className="flex items-center gap-2">
                  <div className="w-7 h-7 rounded-lg bg-indigo-100 dark:bg-indigo-900/40 text-indigo-700 dark:text-indigo-300 flex items-center justify-center">
                    <Globe size={15} />
                  </div>
                  <div>
                    <h4 className="text-xs font-bold text-slate-800 dark:text-slate-200">
                    ...
                    <p className="text-[10px] text-slate-500 dark:text-slate-400">Government Identity &amp; Travel</p>
                  </div>
                </div>
                {hasPassportFile && (
                  <span className="inline-flex items-center gap-0.5 text-[10px] font-semibold text-emerald-600 dark:text-emerald-400 bg-emerald-50 dark:bg-emerald-900/30 border border-emerald-200 dark:border-emerald-800/60 px-1.5 py-0.5 rounded-md">
              ...
              <div className="grid grid-cols-2 gap-2 mb-3">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-2.5 py-1.5 text-xs font-mono font-bold uppercase border border-slate-200 dark:border-slate-700 rounded-lg bg-white dark:bg-slate-900 focus:ring-2 focus:ring-blue-500"
                  />
                </div>
                <div>
                  <label className="text-[10px] font-semibold text-slate-600 dark:text-slate-400 block mb-0.5">
          ...
          <div className="rounded-xl border border-slate-200/90 bg-slate-50/50 p-4 flex flex-col justify-between space-y-3">
            <div>
              <div className="flex items-center justify-between mb-2">
                <div className="flex items-center gap-2">
                  <div className="w-7 h-7 rounded-lg bg-emerald-100 dark:bg-emerald-900/40 text-emerald-700 dark:text-emerald-300 flex items-center justify-center">
                    <FileCheck size={15} />
                  </div>
                  <div>
                    <h4 className="text-xs font-bold text-slate-800 dark:text-slate-200">
                    ...
                    <p className="text-[10px] text-slate-500 dark:text-slate-400">Ministry of Labour &amp; ROP Visa</p>
                  </div>
                </div>
                {effectiveNationality === 'Omani' ? (
                  <span className="text-[10px] font-semibold text-slate-500 dark:text-slate-400 bg-slate-200/80 px-2 py-0.5 rounded-md">
                    N/A (Omani Citizen)
                  </span>
                ) : hasVisaFile ? (
                  <span className="inline-flex items-center gap-0.5 text-[10px] font-semibold text-emerald-600 dark:text-emerald-400 bg-emerald-50 dark:bg-emerald-900/30 border border-emerald-200 dark:border-emerald-800/60 px-1.5 py-0.5 rounded-md">
              ...
              {effectiveNationality === 'Omani' ? (
                <div className="p-3 bg-white dark:bg-slate-900 rounded-lg border border-slate-200 dark:border-slate-700 text-center my-4">
                  <Info className="w-5 h-5 text-slate-400 dark:text-slate-500 mx-auto mb-1" />
                  <p className="text-xs font-semibold text-slate-700 dark:text-slate-300">Omani National</p>
                  <p className="text-[11px] text-slate-500 dark:text-slate-400 mt-0.5">
        ...
        <div className="mt-4 pt-3 border-t border-slate-100 dark:border-slate-800">
          <div className="flex items-center justify-between">
            <button
              ...
              className="text-xs font-semibold text-slate-700 dark:text-slate-300 hover:text-indigo-600 flex items-center gap-1.5 transition-colors cursor-pointer"
            >
              ...
              {hasDlFile && (
                <span className="text-[10px] font-semibold text-emerald-700 dark:text-emerald-300 bg-emerald-50 dark:bg-emerald-900/30 border border-emerald-200 dark:border-emerald-800/60 px-1.5 py-0.2 rounded-md ml-1">
                  Attached
                </span>
              )}
            </button>
          ...
          {showOptionalDl && (
            <div className="mt-3 p-4 bg-slate-50/70 rounded-xl border border-slate-200 dark:border-slate-700 space-y-3">
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-2.5 py-1.5 text-xs font-mono font-bold border border-slate-200 dark:border-slate-700 rounded-lg bg-white dark:bg-slate-900"
                  />
                </div>
                <div>
                  <label className="text-[10px] font-semibold text-slate-600 dark:text-slate-400 block mb-0.5">
                  ...
                  <input
                    ...
                    className="w-full px-2.5 py-1.5 text-xs border border-slate-200 dark:border-slate-700 rounded-lg bg-white dark:bg-slate-900"
                  />
                </div>
      ...
      <div id="employee-banking-section" className="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-700 p-5 shadow-xs">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between border-b border-slate-100 dark:border-slate-800 pb-3 mb-4 gap-2">
          <div className="flex items-center gap-2">
            <div className="p-1.5 bg-emerald-50 dark:bg-emerald-900/30 text-emerald-700 dark:text-emerald-300 rounded-lg">
              <Landmark size={18} />
            </div>
            <div>
          ...
          <div className="flex items-center gap-2">
            {personalForm.iban && ibanValidation.isValid ? (
              <span className="inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-[10px] font-semibold bg-emerald-100 dark:bg-emerald-900/40 text-emerald-800 dark:text-emerald-300 border border-emerald-200 dark:border-emerald-800/60">
                <Check size={12} /> CBO 23-Digit IBAN (Mod-97 Verified)
              </span>
            ) : personalForm.iban ? (
              <span className="inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-[10px] font-semibold bg-red-100 dark:bg-red-900/40 text-red-800 dark:text-red-300 border border-red-200 dark:border-red-800/60">
              ...
              <span className="inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-[10px] font-semibold bg-blue-100 dark:bg-blue-900/40 text-blue-800 dark:text-blue-300 border border-blue-200 dark:border-blue-800/60">
              ...
              <span className="inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-[10px] font-medium bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-400">
                No Bank Registered
              </span>
            )}
          </div>
        ...
        {bankSubmitAttempted && !bankFormValidation.isValid && (
          <div className="p-3.5 mb-4 bg-red-50 dark:bg-red-900/30 border border-red-200 dark:border-red-800/60 rounded-xl flex items-start gap-3 text-xs text-red-900 dark:text-red-300 animate-in fade-in duration-200">
            ...
            <div className="flex-1">
              ...
              <ul className="list-disc list-inside mt-1.5 space-y-1 text-[11px] text-red-800 dark:text-red-300 font-medium">
        ...
        {(!bankSubmitAttempted || bankFormValidation.isValid) &&
          (bankFormValidation.warnings.bankName ||
            ...
            <div className="p-3 mb-4 bg-amber-50/80 border border-amber-200 dark:border-amber-800/60 rounded-lg flex items-start gap-2.5 text-xs text-amber-900 dark:text-amber-300">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          <div>
            <label className="block text-xs font-semibold text-slate-700 dark:text-slate-300 mb-1">
              Bank Name <span className="text-slate-400 dark:text-slate-500 font-normal">(Oman / Licensed Bank)</span>
            </label>
            <div className="space-y-1.5">
              ...
              {(!OMAN_BANKS.includes(personalForm.bankName || '') || personalForm.bankName === '') && (
                <input
                  ...
                  className="w-full px-3 py-1.5 text-xs border border-dashed border-slate-300 dark:border-slate-600 rounded-lg focus:ring-2 focus:ring-blue-500 bg-slate-50 dark:bg-slate-800/60"
                />
              )}
            </div>
          </div>
          ...
          <div>
              ...
              <input
                ...
                className={`w-full pl-3 pr-8 py-2 text-xs font-mono font-medium border rounded-lg transition-colors ${
                  !accountValidation.isValid
                    ? 'border-red-400 dark:border-red-600 bg-red-50/20 focus:ring-2 focus:ring-red-400 text-red-900 dark:text-red-300'
                    : personalForm.bankAccountNumber
                    ? 'border-emerald-400 dark:border-emerald-600 bg-emerald-50/15 focus:ring-2 focus:ring-emerald-500 text-slate-800 dark:text-slate-200'
                    : 'border-slate-200 dark:border-slate-700 focus:ring-2 focus:ring-blue-500 bg-white dark:bg-slate-900'
                }`}
              />
              {personalForm.bankAccountNumber && (
            ...
            {!accountValidation.isValid ? (
              <div className="mt-1 space-y-1">
                ...
                {accountValidation.error?.includes('IBAN') && (
                  <button
                    ...
                    className="text-[11px] font-bold text-blue-700 dark:text-blue-300 hover:text-blue-900 underline flex items-center gap-1 cursor-pointer"
                  >
              ...
              <p className="text-[11px] text-amber-700 dark:text-amber-300 font-medium flex items-start gap-1 mt-1">
          ...
          <div>
              ...
              <div className="flex items-center gap-2 text-[11px]">
                {personalForm.iban && (
                  <button
                    ...
                    className="text-slate-500 dark:text-slate-400 hover:text-slate-700 dark:hover:text-slate-200 cursor-pointer text-[10px] underline"
                  >
                ...
                {personalForm.iban && (
                  <button
                    ...
                    className="inline-flex items-center gap-1 font-semibold text-blue-600 dark:text-blue-400 hover:text-blue-800 cursor-pointer"
                    title="Copy IBAN"
                  >
                    {copiedIban ? (
                      <>
              ...
              <input
                ...
                className={`w-full pl-3 pr-8 py-2 text-xs font-mono font-bold tracking-wider border rounded-lg transition-colors ${
                  !ibanValidation.isValid
                    ? 'border-red-400 dark:border-red-600 bg-red-50/20 focus:ring-2 focus:ring-red-400 text-red-900 dark:text-red-300'
                    : personalForm.iban
                    ? 'border-emerald-400 dark:border-emerald-600 bg-emerald-50/15 focus:ring-2 focus:ring-emerald-500 text-blue-900 dark:text-blue-300'
                    : 'border-slate-200 dark:border-slate-700 focus:ring-2 focus:ring-blue-500 bg-white dark:bg-slate-900'
                }`}
              />
              {personalForm.iban && (
            ...
            {!ibanValidation.isValid ? (
              ...
              <div className="mt-1 flex items-center justify-between text-[10px] text-emerald-700 dark:text-emerald-300 font-medium">
                <span className="flex items-center gap-1">
                  <Check size={12} /> CBO Standard 23-char IBAN &amp; Mod-97 verified
                </span>
                <span className="font-mono text-slate-500 dark:text-slate-400">23/23 chars</span>
              </div>
            ) : (
          ...
          <div className="bg-slate-50 dark:bg-slate-800/60 border border-slate-200 dark:border-slate-700 rounded-lg p-2.5 flex items-start gap-2 text-xs text-slate-600 dark:text-slate-400">
            <Info size={16} className="text-blue-600 dark:text-blue-400 shrink-0 mt-0.5" />
            <div>
              <span className="font-semibold text-slate-800 dark:text-slate-200">WPS &amp; SIF Integration:</span>
      ...
      <div className="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-700 p-5 shadow-xs">
        <div className="flex items-center justify-between border-b border-slate-100 dark:border-slate-800 pb-3 mb-4">
          <div className="flex items-center gap-2">
            <Phone className="text-rose-600 dark:text-rose-400" size={18} />
            <h3 className="font-bold text-slate-800 dark:text-slate-200 text-sm">
              ...
              <div className="flex items-center justify-between">
                ...
                {idx > 0 && canWrite && (
                  <button
                    ...
                    className="text-rose-600 dark:text-rose-400 hover:text-rose-800 text-xs flex items-center gap-1 cursor-pointer"
                  >
                    <Trash2 size={13} />
                    <span>Remove</span>
                  </button>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 text-xs border border-slate-200 dark:border-slate-700 rounded-lg bg-white dark:bg-slate-900 focus:ring-2 focus:ring-blue-500"
                  />
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 text-xs border border-slate-200 dark:border-slate-700 rounded-lg bg-white dark:bg-slate-900 font-mono focus:ring-2 focus:ring-blue-500"
                  />
                </div>
            ...
            {canWrite && (
              <div className="flex gap-2 mb-2.5">
                <input
                  ...
                  className="flex-1 px-3 py-1.5 text-xs border border-slate-200 dark:border-slate-700 rounded-lg bg-white dark:bg-slate-900"
                />
                <button
                  type="button"
                  onClick={addQualification}
                  className="px-3 py-1.5 bg-indigo-50 dark:bg-indigo-900/30 hover:bg-indigo-100 dark:hover:bg-indigo-900/50 text-indigo-700 dark:text-indigo-300 rounded-lg text-xs font-semibold cursor-pointer"
                >
                  Add
                </button>
              </div>
            ...
            <div className="flex flex-wrap gap-1.5 min-h-[36px]">
              {(personalForm.qualifications || []).map((q, idx) => {
                ...
                return (
                  <span
                    key={idx}
                    className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-md text-xs bg-indigo-50 dark:bg-indigo-900/30 text-indigo-800 dark:text-indigo-300 border border-indigo-100 dark:border-indigo-800/60"
                  >
                    <span className="flex items-center gap-1">
              ...
              {(!personalForm.qualifications || personalForm.qualifications.length === 0) && (
                <span className="text-xs text-slate-400 dark:text-slate-500 italic">No academic degrees recorded.</span>
              )}
            </div>
          </div>
            ...
            {canWrite && (
              <div className="flex gap-2 mb-2.5">
                ...
                <button
                  type="button"
                  onClick={addSkill}
                  className="px-3 py-1.5 bg-amber-50 dark:bg-amber-900/30 hover:bg-amber-100 dark:hover:bg-amber-900/50 text-amber-700 dark:text-amber-300 rounded-lg text-xs font-semibold cursor-pointer"
                >
                  Add
                </button>
              </div>
            ...
            <div className="flex flex-wrap gap-1.5 min-h-[36px]">
              {(personalForm.skills || []).map((s, idx) => {
                ...
                return (
                  <span
                    key={idx}
                    className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-md text-xs bg-amber-50 dark:bg-amber-900/30 text-amber-800 dark:text-amber-300 border border-amber-100 dark:border-amber-800/60"
                  >
                    <span>{text}</span>
                    {canWrite && (
                      <button
              ...
              {(!personalForm.skills || personalForm.skills.length === 0) && (
                <span className="text-xs text-slate-400 dark:text-slate-500 italic">No technical skills recorded.</span>
              )}
            </div>
          </div>
        </div>

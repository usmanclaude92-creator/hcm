...
function MonthOverMonthBadge({ current, previous }: { current?: number; previous?: number }) {
  ...
  const isUp = pct >= 0;
  return (
    <span className={`inline-flex items-center gap-0.5 text-[11px] font-semibold ${isUp ? 'text-emerald-600 dark:text-emerald-400' : 'text-rose-600 dark:text-rose-400'}`}>
...
export const DashboardView: React.FC<DashboardViewProps> = ({ onNavigate, initialTab }) => {
    ...
    return (
      <div className="p-8 flex items-center justify-center min-h-[400px]">
        <div className="flex flex-col items-center gap-3">
          ...
          <p className="text-sm font-medium text-slate-500 dark:text-slate-400">Loading payroll intelligence metrics...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="rounded-2xl border border-slate-200 dark:border-slate-700 shadow-xs overflow-hidden">
        ...
        <div className="px-4 sm:px-6 py-3 border-t border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800/60 flex flex-col lg:flex-row lg:items-center justify-between gap-3">
          <div className="inline-flex items-center gap-1.5 bg-slate-100 dark:bg-slate-800 rounded-xl p-1.5 self-start">
            {TABS.map((tab) => {
              const Icon = tab.icon;
                ...
                <button
                  ...
                  className={`flex items-center gap-2 px-5 py-2.5 rounded-lg text-sm font-bold transition-all cursor-pointer ${
                    isActive
                      ...
                      : 'text-slate-500 dark:text-slate-400 hover:bg-white hover:text-slate-800'
                  }`}
                >
          ...
          {activeTab === 'payroll-insights' ? (
            ...
            <div className="flex items-center gap-3 shrink-0">
              <div className="flex items-center gap-1.5 px-3 py-1.5 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-lg shadow-2xs">
              ...
              <button
                ...
                className="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-semibold text-slate-700 dark:text-slate-300 bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-600 rounded-lg hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors shadow-2xs cursor-pointer"
              >
      ...
      {activeTab === 'workforce-deployment' ? (
        ...
        <>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div className="bg-white dark:bg-slate-900 rounded-xl p-5 border border-slate-200 dark:border-slate-700 shadow-xs hover:border-slate-300 transition-all">
              <div className="flex items-center justify-between">
                <span className="text-xs font-medium text-slate-500 dark:text-slate-400">Finalized Net Salary Owed</span>
              ...
              <div className="mt-3">
                ...
                <div className="text-[11px] text-slate-500 dark:text-slate-400 mt-1 flex items-center gap-1">
                  <span>Status:</span>
                  <span className={`font-semibold ${currentPayroll?.status === 'Finalized' ? 'text-emerald-600 dark:text-emerald-400' : 'text-amber-600 dark:text-amber-400'}`}>
            ...
            <div className="bg-white dark:bg-slate-900 rounded-xl p-5 border border-slate-200 dark:border-slate-700 shadow-xs hover:border-slate-300 transition-all">
              <div className="flex items-center justify-between">
                <span className="text-xs font-medium text-slate-500 dark:text-slate-400">Total Salary Disbursed</span>
              ...
              <div className="mt-3">
                ...
                <div className="text-[11px] text-slate-500 dark:text-slate-400 mt-1 flex items-center justify-between">
                  ...
                  <span className="font-semibold text-rose-600 dark:text-rose-400">OMR {formatOMR(finances?.totalOutstandingSalary)}</span>
                </div>
                <ProgressBar percentage={paidPercentage} colorClass="bg-emerald-500" />
                <span className="text-[10px] text-slate-400 dark:text-slate-500 mt-1 block">{paidPercentage.toFixed(1)}% of finalized payroll paid</span>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-slate-900 rounded-xl p-5 border border-slate-200 dark:border-slate-700 shadow-xs hover:border-slate-300 transition-all">
              <div className="flex items-center justify-between">
                <span className="text-xs font-medium text-slate-500 dark:text-slate-400">WPS Excess Recoverable</span>
              ...
              <div className="mt-3">
                ...
                <div className="text-[11px] text-slate-500 dark:text-slate-400 mt-1 flex items-center justify-between">
                  ...
                  <span className="font-semibold text-slate-700 dark:text-slate-300">OMR {formatOMR(finances?.totalWpsRemaining)}</span>
                </div>
                <ProgressBar percentage={wpsRecoveryPercentage} colorClass="bg-amber-500" />
                <span className="text-[10px] text-slate-400 dark:text-slate-500 mt-1 block">{wpsRecoveryPercentage.toFixed(1)}% recovered</span>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-slate-900 rounded-xl p-5 border border-slate-200 dark:border-slate-700 shadow-xs hover:border-slate-300 transition-all">
              <div className="flex items-center justify-between">
                <span className="text-xs font-medium text-slate-500 dark:text-slate-400">Outstanding Loans</span>
              ...
              <div className="mt-3">
                ...
                <div className="text-[11px] text-slate-500 dark:text-slate-400 mt-1 flex items-center justify-between">
                  <span>Recovered:</span>
                  <span className="font-semibold text-emerald-600 dark:text-emerald-400">OMR {formatOMR(loanAnalytics?.totalRecovered)}</span>
                </div>
          ...
          <div className="bg-slate-50 dark:bg-slate-800/60 rounded-xl p-4 border border-slate-200 dark:border-slate-700 flex flex-wrap items-center justify-between gap-4">
            <div className="flex items-center gap-2">
              ...
              <div>
                <span className="text-xs font-medium text-slate-500 dark:text-slate-400">Active Workforce:</span>
                <strong className="ml-1.5 text-sm text-slate-900 dark:text-slate-100">{counts?.activeEmployees} / {counts?.totalEmployees} Employees</strong>
              </div>
            </div>

            <div className="flex flex-wrap items-center gap-3 text-xs">
              <span className="px-3 py-1 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-md text-slate-700 dark:text-slate-300 font-medium">
                Staff: <strong className="text-blue-600 dark:text-blue-400">{counts?.staff}</strong>
              </span>
              <span className="px-3 py-1 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-md text-slate-700 dark:text-slate-300 font-medium">
                Workers: <strong className="text-indigo-600 dark:text-indigo-400">{counts?.workers}</strong>
              </span>
              <span className="px-3 py-1 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-md text-slate-700 dark:text-slate-300 font-medium">
                Omani Nationals: <strong className="text-emerald-600 dark:text-emerald-400">{counts?.omani}</strong>
              </span>
              <span className="px-3 py-1 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-md text-slate-700 dark:text-slate-300 font-medium">
                Expatriates: <strong className="text-slate-900 dark:text-slate-100">{counts?.expat}</strong>
              </span>
              <span className="px-3 py-1 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-md text-slate-700 dark:text-slate-300 font-medium flex items-center gap-1">
                <UserX className="w-3 h-3 text-slate-400 dark:text-slate-500" />
                Inactive: <strong className="text-slate-500 dark:text-slate-400">{counts?.inactiveEmployees ?? 0}</strong>
              </span>
              <span className="px-3 py-1 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-md text-slate-700 dark:text-slate-300 font-medium flex items-center gap-1">
                <Wallet className="w-3 h-3 text-slate-400 dark:text-slate-500" />
                Avg. Net Salary: <strong className="text-slate-900 dark:text-slate-100">OMR {formatOMR(avgNetSalary)}</strong>
              </span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-2 bg-white dark:bg-slate-900 rounded-xl p-5 border border-slate-200 dark:border-slate-700 shadow-xs">
              <div className="flex items-center justify-between mb-4">
                <div>
                  <h3 className="font-semibold text-slate-900 dark:text-slate-100 text-sm">Monthly Payroll & Payment Trends</h3>
                  <p className="text-xs text-slate-500 dark:text-slate-400">Gross Salary vs. Net Salary vs. Actually Paid (OMR)</p>
                </div>
                <span className="text-xs text-blue-600 dark:text-blue-400 bg-blue-50 dark:bg-blue-900/30 px-2.5 py-1 rounded-md font-medium">
                  {periodLabel || 'Trend'}
                </span>
              </div>
              ...
              {(() => {
                ...
                if (compositionMode === 'job') {
                  return (
                    <>
                      ...
                      <div className="border-t border-slate-100 dark:border-slate-800 pt-3 max-h-24 overflow-y-auto pr-1">
                          ...
                          {jobData.map((job: any, idx: number) => {
                            ...
                            return (
                              <div key={job.name} className="flex items-center gap-1.5" title={`${job.name}: ${job.value} (${pct}%)`}>
                                ...
                                <span className="text-slate-600 dark:text-slate-400 truncate max-w-[120px]">{job.name}:</span>
                                <span className="font-bold text-slate-800 dark:text-slate-200">{job.value}</span>
                ...
                return (
                  <>
                    ...
                    <div className="border-t border-slate-100 dark:border-slate-800 pt-3 flex items-center justify-around text-xs">
                      <div className="flex items-center gap-1.5">
                        <span className="w-3 h-3 rounded-full bg-blue-600" />
                        <span className="text-slate-600 dark:text-slate-400">Staff: <strong className="text-slate-900 dark:text-slate-100">{counts?.staff}</strong></span>
                      </div>
                      <div className="flex items-center gap-1.5">
                        <span className="w-3 h-3 rounded-full bg-indigo-600" />
                        <span className="text-slate-600 dark:text-slate-400">Workers: <strong className="text-slate-900 dark:text-slate-100">{counts?.workers}</strong></span>
                      </div>
                    </div>
                  </>
                );
            ...
            <div className="bg-white dark:bg-slate-900 rounded-xl p-5 border border-slate-200 dark:border-slate-700 shadow-xs">
              <div className="flex items-center justify-between mb-4">
                <div>
                  ...
                  <p className="text-xs text-slate-500 dark:text-slate-400">WPS Salary Liability vs. Recovery Progress</p>
                </div>
              </div>
              <div className="grid grid-cols-2 gap-3 mb-4">
                <div className="p-3 bg-slate-50 dark:bg-slate-800/60 rounded-lg">
                  <span className="text-[11px] text-slate-500 dark:text-slate-400">WPS Salary (Selected Period)</span>
                  <div className="text-base font-bold text-slate-900 dark:text-slate-100">OMR {formatOMR(currentPayroll?.wpsSalary)}</div>
                </div>
                <div className="p-3 bg-amber-50 dark:bg-amber-900/30 rounded-lg">
                  <span className="text-[11px] text-amber-700 dark:text-amber-300">Total Recoverable</span>
                  <div className="text-base font-bold text-amber-800 dark:text-amber-300">OMR {formatOMR(finances?.totalWpsRecoverable)}</div>
                </div>
                <div className="p-3 bg-emerald-50 dark:bg-emerald-900/30 rounded-lg">
                  <span className="text-[11px] text-emerald-700 dark:text-emerald-300">Recovered</span>
                  <div className="text-base font-bold text-emerald-800 dark:text-emerald-300">OMR {formatOMR(finances?.totalWpsRecovered)}</div>
                </div>
                <div className="p-3 bg-rose-50 dark:bg-rose-900/30 rounded-lg">
                  <span className="text-[11px] text-rose-700 dark:text-rose-300">Pending Recovery</span>
                  <div className="text-base font-bold text-rose-800 dark:text-rose-300">OMR {formatOMR(finances?.totalWpsRemaining)}</div>
                </div>
              </div>
              <div>
                <div className="flex items-center justify-between text-[11px] text-slate-500 dark:text-slate-400 mb-1">
                  <span>Recovery Progress</span>
                  <span className="font-semibold text-amber-700 dark:text-amber-300">{wpsRecoveryPercentage.toFixed(1)}%</span>
                </div>
                <ProgressBar percentage={wpsRecoveryPercentage} colorClass="bg-amber-500" />
              </div>
            </div>
              ...
              <div className="border-t border-slate-100 dark:border-slate-800 pt-3 flex items-center justify-around text-xs">
                {workforceCostByCategory?.map((c: any) => (
                  <div key={c.name} className="text-center">
                    ...
                    <div className="font-semibold text-slate-800 dark:text-slate-200">{c.count} employees</div>
                  </div>
                ))}
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <div className="bg-white dark:bg-slate-900 rounded-xl p-5 border border-slate-200 dark:border-slate-700 shadow-xs">
              <div className="mb-4">
                ...
                <p className="text-xs text-slate-500 dark:text-slate-400">Active Employee Loans &amp; Recovery Progress</p>
              </div>
              <div className="grid grid-cols-2 gap-3 mb-4">
                <div className="p-3 bg-slate-50 dark:bg-slate-800/60 rounded-lg">
                  <span className="text-[11px] text-slate-500 dark:text-slate-400">Total Principal (Active)</span>
                  <div className="text-base font-bold text-slate-900 dark:text-slate-100">OMR {formatOMR(loanAnalytics?.totalPrincipal)}</div>
                </div>
                <div className="p-3 bg-emerald-50 dark:bg-emerald-900/30 rounded-lg">
                  <span className="text-[11px] text-emerald-700 dark:text-emerald-300">Total Recovered</span>
                  <div className="text-base font-bold text-emerald-800 dark:text-emerald-300">OMR {formatOMR(loanAnalytics?.totalRecovered)}</div>
                </div>
                <div className="p-3 bg-purple-50 dark:bg-purple-900/30 rounded-lg">
                  <span className="text-[11px] text-purple-700 dark:text-purple-300">Outstanding Balance</span>
                  <div className="text-base font-bold text-purple-800 dark:text-purple-300">OMR {formatOMR(loanAnalytics?.outstandingBalance)}</div>
                </div>
                <div className="p-3 bg-blue-50 dark:bg-blue-900/30 rounded-lg">
                  <span className="text-[11px] text-blue-700 dark:text-blue-300">Recovery (Selected Period)</span>
                  <div className="text-base font-bold text-blue-800 dark:text-blue-300">OMR {formatOMR(loanAnalytics?.monthlyRecovery)}</div>
                </div>
              </div>
              <div>
                <div className="flex items-center justify-between text-[11px] text-slate-500 dark:text-slate-400 mb-1">
                  <span>Recovery Progress • {loanAnalytics?.activeLoanCount ?? 0} Active Loan(s)</span>
                  <span className="font-semibold text-purple-700 dark:text-purple-300">{(loanAnalytics?.recoveryPercentage ?? 0).toFixed(1)}%</span>
                </div>
                <ProgressBar percentage={loanAnalytics?.recoveryPercentage} colorClass="bg-purple-500" />
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-slate-900 rounded-xl p-5 border border-slate-200 dark:border-slate-700 shadow-xs">
              <div className="mb-4">
                ...
                <p className="text-xs text-slate-500 dark:text-slate-400">Net Salary Owed vs. Actually Disbursed, by Month</p>
              </div>
              {monthlyTrends && monthlyTrends.length > 0 ? (
                <div className="space-y-2">
                  {monthlyTrends.map((m: any, idx: number) => {
                    ...
                    return (
                      <div key={m.month} className="flex items-center justify-between p-2.5 bg-slate-50 dark:bg-slate-800/60 rounded-lg text-xs">
                        <div className="font-semibold text-slate-700 dark:text-slate-300 w-20">{m.month}</div>
                        <div className="text-slate-500 dark:text-slate-400">
                          Net: <span className="font-mono font-semibold text-slate-900 dark:text-slate-100">OMR {formatOMR(m.netSalary)}</span>
                        </div>
                        <div className="text-slate-500 dark:text-slate-400">
                          Paid: <span className="font-mono font-semibold text-emerald-700 dark:text-emerald-300">OMR {formatOMR(m.paidSalary)}</span>
                        </div>
                        <div className="text-slate-500 dark:text-slate-400">
                          Variance: <span className="font-mono font-semibold text-rose-600 dark:text-rose-400">OMR {formatOMR(variance)}</span>
                        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div
              ...
              className="p-4 bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-700 hover:border-blue-400 shadow-xs hover:shadow-sm cursor-pointer transition-all flex items-center justify-between group"
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h4 className="text-sm font-semibold text-slate-900 dark:text-slate-100">Employee Master</h4>
                  <p className="text-xs text-slate-500 dark:text-slate-400">Excel Import/Export & Histories</p>
                </div>
              </div>
              <ArrowRight className="w-4 h-4 text-slate-400 dark:text-slate-500 group-hover:text-blue-600 group-hover:translate-x-0.5 transition-all" />
            </div>
            ...
            >
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-lg bg-indigo-50 dark:bg-indigo-900/30 text-indigo-600 dark:text-indigo-400 flex items-center justify-center group-hover:bg-indigo-600 group-hover:text-white transition-colors">
                  <Briefcase className="w-5 h-5" />
                </div>
                <div>
                  <h4 className="text-sm font-semibold text-slate-900 dark:text-slate-100">Attendance Register</h4>
                  <p className="text-xs text-slate-500 dark:text-slate-400">Multi-Project Days & Hours</p>
                </div>
              </div>
              <ArrowRight className="w-4 h-4 text-slate-400 dark:text-slate-500 group-hover:text-blue-600 group-hover:translate-x-0.5 transition-all" />
            </div>
            ...
            >
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-lg bg-emerald-50 dark:bg-emerald-900/30 text-emerald-600 dark:text-emerald-400 flex items-center justify-center group-hover:bg-emerald-600 group-hover:text-white transition-colors">
                  <DollarSign className="w-5 h-5" />
                </div>
                <div>
                  <h4 className="text-sm font-semibold text-slate-900 dark:text-slate-100">Financial Reports</h4>
                  <p className="text-xs text-slate-500 dark:text-slate-400">5 Categorical Excel Ledgers</p>
                </div>
              </div>
              <ArrowRight className="w-4 h-4 text-slate-400 dark:text-slate-500 group-hover:text-blue-600 group-hover:translate-x-0.5 transition-all" />
            </div>

      ...
      <div className="bg-white dark:bg-slate-900 p-4 rounded-xl border border-slate-200 dark:border-slate-700 shadow-xs flex flex-col sm:flex-row items-center gap-3">
        <div className="flex-1 relative w-full">
          ...
          <input
            ...
            className="w-full pl-9 pr-3 py-2 bg-slate-50 dark:bg-slate-800/60 border border-slate-200 dark:border-slate-700 rounded-lg text-xs focus:ring-2 focus:ring-indigo-500"
          />
        </div>
        ...
        <div className="w-full sm:w-48">
          <select
            ...
            className="w-full px-2.5 py-2 bg-slate-50 dark:bg-slate-800/60 border border-slate-200 dark:border-slate-700 rounded-lg text-xs text-slate-700 dark:text-slate-300 focus:ring-2 focus:ring-indigo-500"
          >
                ...
                projects.map((proj) => (
                  <tr key={proj.id} className="hover:bg-slate-50/75 transition-colors">
                    <td className="px-6 py-4">
                      ...
                      <div className="font-mono text-xs text-slate-500 dark:text-slate-400">{proj.projectCode}</div>
                    </td>
                    ...
                    <td className="px-6 py-4 text-xs">
                      {proj.allowedCompanies?.length ? (
                        ...
                        <span className="text-slate-400 dark:text-slate-500">Unrestricted</span>
                      )}
                    </td>
                    <td className="px-6 py-4">
            ...
            <form onSubmit={handleSaveProject} className="p-6 space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 border border-slate-200 dark:border-slate-700 rounded-lg text-xs font-mono font-bold uppercase focus:ring-2 focus:ring-indigo-500"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 border border-slate-200 dark:border-slate-700 rounded-lg text-xs focus:ring-2 focus:ring-indigo-500"
                />
              </div>
              ...
              <div className="pt-4 border-t border-slate-200 dark:border-slate-700 flex justify-end gap-2.5">
                <button
                  type="button"
                  onClick={() => setIsModalOpen(false)}
                  className="px-4 py-2 text-xs font-semibold text-slate-700 dark:text-slate-300 bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-600 rounded-lg transition-colors"
                >
                  Cancel
                </button>
                <button
